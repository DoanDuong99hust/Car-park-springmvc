...
<div class="col-sm-3 bg-light p-0 border h-auto">
    ...
    <div class="dropdown bg-light">
        ...
        <div class="dropdown-menu bg-light border-0">
            <a class="dropdown-item" href='<c:url value="/employee/employee-list?page=1&limit=2"/>'><i class="fas fa-list"></i> Employee list</a>
            <a class="dropdown-item" href='<c:url value="/employee/employee-edit"/>'><i class="fas fa-plus"></i> Add employee</a>
        </div>
    </div>
</div>
