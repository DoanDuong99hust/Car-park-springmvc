...
<%--            <a class="dropdown-item" href='<c:url value="/car-park-car-list?type=edit"/>'><i class="fas fa-plus"></i> Add car</a>--%>
    ...
    <div class="dropdown bg-light" style="height: 110px">
        ...
        <div class="dropdown-menu bg-light border-0">
            <a class="dropdown-item" href='<c:url value="/car-park/booking-office/list?page=1&limit=2"/>'><i class="fas fa-list"></i> Booking office list</a>
            <a class="dropdown-item" href='<c:url value="/car-park/booking-office/edit"/>'><i class="fas fa-plus"></i> Add Booking office</a>
        </div>
    </div>
    <div class="dropdown bg-light" style="height: 110px">
        <div class="btn btn-light d-flex justify-content-center dropdown-toggle" data-toggle="dropdown">
...
<%--            <a class="dropdown-item" href='<c:url value="/car-park-ticket-list?type=edit"/>'><i class="fas fa-plus"></i> Add ticket</a>--%>
    ...
    <div class="dropdown bg-light" style="height: 110px">
        ...
        <div class="dropdown-menu bg-light border-0">
            <a class="dropdown-item" href='<c:url value="/car-park/trip/list?page=1&limit=2"/>'><i class="fas fa-list"></i> Trip list</a>
            <a class="dropdown-item" href='<c:url value="/car-park/trip/edit"/>'><i class="fas fa-plus"></i> Add trip</a>
        </div>
    </div>
</div>
