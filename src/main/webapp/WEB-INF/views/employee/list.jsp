<%@include file="/common/taglib.jsp"%>
    <c:url var="APIurl" value="/api/employee" />
    <c:url var="NewURL" value="/employee/employee-list" />
    ...
    pageEncoding="UTF-8"%>
        ...
        <body>
            <div class="col-sm-9">
                ...
                <form action="<c:url value='/employee/employee-list'/>" id="formSubmit" method="get">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:url var="editURL" value="/employee/employee-edit">
